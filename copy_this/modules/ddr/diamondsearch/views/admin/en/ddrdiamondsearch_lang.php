...
$aLang = array(
    ...
    'SHOP_MODULE_DdrDiamondSearchStopWords'       => 'Stop words for each language - not needed terms, that should not indexed and found by Diamond Search.',
    ...
    'SHOP_MODULE_DdrDiamondSearchPromoTitle'      => 'A title of the default promotion articles widget box.',
    'SHOP_MODULE_DdrDiamondSearchPromoQuery'      => 'A search query for default promotion articles list.',
);
